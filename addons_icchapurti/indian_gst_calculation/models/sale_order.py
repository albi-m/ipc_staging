                ...
                for tax in line.tax_id:
                    if tax.amount_type == "group":
                        ...
                        if order.order_id.CGST_SGST == True:
                            ...
                            line.sale_amount_CGST = round(line.price_subtotal * line.sale_CGST/100, 2)
                            line.sale_amount_SGST = round(line.price_subtotal * line.sale_SGST/100, 2)
                        elif order.order_id.IGST == True:
                            line.sale_IGST = total_gst
                            line.sale_amount_IGST = round(line.price_subtotal * line.sale_IGST/100, 2)
                        elif order.order_id.UTGST == True:
                            line.sale_UTGST = total_gst
                            line.sale_amount_UTGST = round(line.price_subtotal * line.sale_UTGST/100, 2)
                        else:
