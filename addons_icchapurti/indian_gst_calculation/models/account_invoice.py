...
class CustomAccountInvoice(models.Model):
    """
        Adds three GST amount columns to sale order model.
    """
                ...
                for tax in line.tax_ids:
                    ...
                    if tax.amount_type == "group":
                        ...
                        if line.move_id.CGST_SGST == True:
                            ...
                            line.invoice_amount_CGST = round(line.price_subtotal * line.invoice_CGST/100, 2)
                            line.invoice_amount_SGST = round(line.price_subtotal * line.invoice_SGST/100, 2)
                        elif line.move_id.IGST == True:
                            line.invoice_IGST = total_gst
                            line.invoice_amount_IGST = round(line.price_subtotal * line.invoice_IGST/100, 2)
                        elif line.move_id.UTGST == True:
                            line.invoice_UTGST = total_gst
                            line.invoice_amount_UTGST = round(line.price_subtotal * line.invoice_UTGST/100, 2)
                        else:
